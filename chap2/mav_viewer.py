"""
example of drawing a box-like aircraft in python
...
class mav_viewer():
    def __init__(self):
        ...
        self.plot_initialized = False # has the aircraft been plotted yet?
        # get points that define the non-rotated, non-translated aircraft and the mesh colors
    ...
    def update(self, state):
        """
        Update the drawing of the aircraft.
        ...
        # attitude of aircraft as a rotation matrix R from body to inertial
        R = self._Euler2Rotation(state.phi, state.theta, state.psi)
        # rotate and translate points defining aircraft
        ...
        # update the center of the camera view to the aircraft location
    ...
    def _get_MAV_points(self):
        """"
            Points that define the aircraft, and the colors of the triangular mesh
